...
import articleImg1 from "../../assets/images/blog/1.jpg";
import articleImg2 from "../../assets/images/blog/2.jpg";
import articleImg3 from "../../assets/images/blog/3.jpg";
import articleImg4 from "../../assets/images/blog/4.png";
              ...
              <div class="article">
                ...
                <div class="article__score">
                  <div class="article__score-icons">
                    <img src={starFillIcon} class="article__score-icon" />
                    <img src={starFillIcon} class="article__score-icon" />
                    <img src={starFillIcon} class="article__score-icon" />
                    <img src={starFillIcon} class="article__score-icon" />
                    <img src={starIcon} class="article__score-icon" />
                  </div>
